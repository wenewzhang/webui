export default {
  ...
  pool: {
    ...
    advancedImportTitle: 'Advanced Import Pool',
  ...
  dockerContainers: {
    ...
    logsTitle: "Logs for container '{id}'",
    fetchLogsFailed: 'Failed to fetch logs',
    noLogs: 'No logs available',
    createNote: 'Notes',
    notesTitle: 'Container Notes',
  ...
  systemServices: {
    ...
    startSuccess: "Service '{name}' started successfully",
    startFailed: 'Failed to start service',
    restartSuccess: "Service '{name}' restarted successfully",
    restartFailed: 'Failed to restart service',
    stopSuccess: "Service '{name}' stopped successfully",
  ...
  systemUpdater: {
    ...
    downloading: 'Downloading...',
    downloadCompletedAndVerified: 'Download completed and verified: {filename}',
    updateCheckUnavailable: 'Update check unavailable, current status: {status}',
    upgrading: 'Upgrading System',
    upgradeStarted: 'Upgrade started',
    upgradeCommandSent: 'Upgrade command sent successfully',
  ...
  systemLogger: {
    ...
    readLogFailed: 'Failed to read log file',
    logFileNotFound: 'Log file does not exist',
    logPermissionDenied: 'Permission denied to read log file',
    pageSize: 'Lines per page',
    totalLines: 'Total lines',
    pageInfo: 'Page {page} / {totalPages}',
  },
