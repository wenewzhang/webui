export default {
  ...
  common: {
    ...
    chmodFailedForDirectory: "修改目录 '{path}' 权限失败, 如果是从TrueNAS导入的磁盘原来启用了ACL,可能需要手动清除,参考指令:\nsetfacl -bR store/tools\nzfs set aclmode=discard store/tools\n",
  },
  // 登录页面
  login: {
    title: '系统登录',
  ...
  dataset: {
    ...
    deletePermissionDenied: '权限不足：只有管理员才能执行此操作',
  ...
  samba: {
    ...
    closeDirShareConfirm: "确定要关闭目录共享 '{name}' 吗？",
    confirmEdit: '确认修改',
  ...
  dockerSettings: {
    ...
    inputPrefix: '请选择或输入前缀',
    inputLocation: '请选择或输入地址',
  ...
  systemUpdater: {
    ...
    downloading: '下载中...',
    downloadCompletedAndVerified: '下载完成并已验证：{filename}',
    updateCheckUnavailable: '更新检查不可用，当前状态：{status}',
    upgrade: '升级系统',
    upgrading: '正在升级系统',
    upgradeStarted: '升级已开始',
    upgradeCommandSent: '升级命令已发送',
    upgradeFailed: '升级失败',
  ...
  systemLogger: {
    ...
    logPermissionDenied: '没有权限读取日志文件',
    pageSize: '每页行数',
    totalLines: '总行数',
    pageInfo: '第 {page} / {totalPages} 页',
  },
